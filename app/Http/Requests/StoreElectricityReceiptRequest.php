...
class StoreElectricityReceiptRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'main_current_date.after_or_equal' => 'Current reading date must be on or after previous reading date.',
        ];
    }
}
